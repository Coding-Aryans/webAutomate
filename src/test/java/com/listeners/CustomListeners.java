...
public class CustomListeners extends BaseClass implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		Reporter.log("<a target=\"_blank\" href="+TestDataUtility.screenshotName+">Screenshot</a>");
		Reporter.log("<br>");
		Reporter.log("<br>");
		Reporter.log("<a target=\"_blank\" href="+TestDataUtility.screenshotName+"><img src="+TestDataUtility.screenshotName+" height=200 width=200></img></a>");
		rep.endTest(test);
		rep.flush();
